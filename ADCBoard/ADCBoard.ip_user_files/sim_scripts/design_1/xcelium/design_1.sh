...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../ADCBoard.gen/sources_1/bd/design_1/ipshared/8713/hdl" \
       +incdir+"$ref_dir/../../../../ADCBoard.gen/sources_1/bd/design_1/ipshared/62b6" \
       +incdir+"../../../../ADCBoard.gen/sources_1/bd/design_1/ipshared/8713/hdl" \
       +incdir+"../../../../ADCBoard.gen/sources_1/bd/design_1/ipshared/62b6"
}

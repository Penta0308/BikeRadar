-- VHDL netlist generated by SCUBA ispLever_v8.1_PROD_Build (8)
-- Module  Version: 7.1
--d:\ispTOOLS8_1\ispfpga\bin\nt\scuba.exe -w -lang vhdl -synth synplify -bus_exp 7 -bb -arch mj5g00 -type bram -wp 11 -rp 1010 -data_width 8 -rdata_width 8 -num_rows 128 -outdataA REGISTERED -writemodeA NORMAL -writemodeB NORMAL -resetmode SYNC -cascade -1 -e 

-- Mon May 24 10:00:19 2010
...
architecture Structure of dpram is
    ...
    attribute MEM_LPC_FILE of dpram_0_0_0 : label is "dpram.lpc";
    attribute MEM_INIT_FILE of dpram_0_0_0 : label is "";
    attribute CSDECODE_B of dpram_0_0_0 : label is "0b000";
    attribute CSDECODE_A of dpram_0_0_0 : label is "0b000";
    attribute WRITEMODE_B of dpram_0_0_0 : label is "NORMAL";
    attribute WRITEMODE_A of dpram_0_0_0 : label is "NORMAL";
    attribute GSR of dpram_0_0_0 : label is "DISABLED";
    attribute RESETMODE of dpram_0_0_0 : label is "SYNC";
    attribute REGMODE_B of dpram_0_0_0 : label is "NOREG";
    attribute REGMODE_A of dpram_0_0_0 : label is "OUTREG";
    attribute DATA_WIDTH_B of dpram_0_0_0 : label is "9";
    attribute DATA_WIDTH_A of dpram_0_0_0 : label is "9";
...
begin
    ...
    dpram_0_0_0: DP8KB
        ...
        port map (CEA=>ClockEnA, CLKA=>ClockA, WEA=>WrA, CSA0=>scuba_vlo, 
            ...
            ADA9=>AddressA(6), ADA10=>scuba_vlo, ADA11=>scuba_vlo, 
            ADA12=>scuba_vlo, DIB0=>DataInB(0), DIB1=>DataInB(1), 
            ...
            ADB2=>scuba_vlo, ADB3=>AddressB(0), ADB4=>AddressB(1), 
            ADB5=>AddressB(2), ADB6=>AddressB(3), ADB7=>AddressB(4), 
            ADB8=>AddressB(5), ADB9=>AddressB(6), ADB10=>scuba_vlo, 
            ADB11=>scuba_vlo, ADB12=>scuba_vlo, DOA0=>QA(0), DOA1=>QA(1), 
            DOA2=>QA(2), DOA3=>QA(3), DOA4=>QA(4), DOA5=>QA(5), 
            DOA6=>QA(6), DOA7=>QA(7), DOA8=>open, DOA9=>open, 
            ...
            DOB4=>QB(4), DOB5=>QB(5), DOB6=>QB(6), DOB7=>QB(7), 

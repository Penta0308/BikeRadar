...
--               c:/Users/penta/Documents/BikeRadar/Bajie7020/Bajie7020.gen/sources_1/bd/bajie7020/ip/bajie7020_firoutmixer_0_0/bajie7020_firoutmixer_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of bajie7020_firoutmixer_0_0_firoutmixer is
  ...
  signal \sample_n[11]_i_2_n_0\ : STD_LOGIC;
  signal \sample_n[11]_i_3_n_0\ : STD_LOGIC;
  signal \sample_n[12]_i_1_n_0\ : STD_LOGIC;
  signal \sample_n[13]_i_1_n_0\ : STD_LOGIC;
  signal \sample_n[13]_i_2_n_0\ : STD_LOGIC;
  signal \sample_n[13]_i_3_n_0\ : STD_LOGIC;
  ...
  signal \sample_n[15]_i_6_n_0\ : STD_LOGIC;
  signal \sample_n[15]_i_7_n_0\ : STD_LOGIC;
  ...
  signal \sample_n[7]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \sample_n_reg[12]_i_2_n_0\ : STD_LOGIC;
  signal \sample_n_reg[12]_i_2_n_1\ : STD_LOGIC;
  signal \sample_n_reg[12]_i_2_n_2\ : STD_LOGIC;
  signal \sample_n_reg[12]_i_2_n_3\ : STD_LOGIC;
  signal \^sample_n_reg[13]_0\ : STD_LOGIC;
  signal \^sample_n_reg[14]_0\ : STD_LOGIC;
  signal \^sample_n_reg[15]_0\ : STD_LOGIC;
  signal \sample_n_reg[15]_i_5_n_2\ : STD_LOGIC;
  signal \sample_n_reg[15]_i_5_n_3\ : STD_LOGIC;
  ...
  signal \sample_n_reg[4]_i_3_n_0\ : STD_LOGIC;
  signal \sample_n_reg[4]_i_3_n_1\ : STD_LOGIC;
  signal \sample_n_reg[4]_i_3_n_2\ : STD_LOGIC;
  signal \sample_n_reg[4]_i_3_n_3\ : STD_LOGIC;
  ...
  signal \sample_n_reg[8]_i_3_n_0\ : STD_LOGIC;
  signal \sample_n_reg[8]_i_3_n_1\ : STD_LOGIC;
  signal \sample_n_reg[8]_i_3_n_2\ : STD_LOGIC;
  signal \sample_n_reg[8]_i_3_n_3\ : STD_LOGIC;
  ...
  signal \NLW_sample_n_reg[15]_i_5_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_sample_n_reg[15]_i_5_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of sample_last_i_2 : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \sample_n[11]_i_3\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \sample_n[13]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \sample_n[15]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \sample_n[15]_i_3\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \sample_n[15]_i_4\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \sample_n[15]_i_6\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \sample_n[15]_i_7\ : label is "soft_lutpair5";
  attribute ADDER_THRESHOLD : integer;
  attribute ADDER_THRESHOLD of \sample_n_reg[12]_i_2\ : label is 35;
  attribute ADDER_THRESHOLD of \sample_n_reg[15]_i_5\ : label is 35;
  attribute ADDER_THRESHOLD of \sample_n_reg[4]_i_3\ : label is 35;
  attribute ADDER_THRESHOLD of \sample_n_reg[8]_i_3\ : label is 35;
  attribute SOFT_HLUTNM of sample_valid_i_4 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of sample_valid_i_5 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of sample_valid_i_6 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of sample_valid_i_7 : label is "soft_lutpair3";
...
sample_begin_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000EAAA"
    )
        port map (
...
sample_begin_i_5: unisim.vcomponents.LUT6
    generic map(
...
sample_begin_i_6: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
...
\sample_n[11]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\sample_n[11]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\sample_n[13]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\sample_n[13]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFEF"
    )
        port map (
...
\sample_n[15]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFF7FFF"
    )
        port map (
...
\sample_n[15]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFF7"
    )
        port map (
...
\sample_n[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\sample_n[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFB"
    )
        port map (
...
\sample_n[8]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFF7FFFFFFFFFFFF"
    )
        port map (
...
\sample_n_reg[12]_i_2\: unisim.vcomponents.CARRY4
     port map (
      CI => \sample_n_reg[8]_i_3_n_0\,
      CO(3) => \sample_n_reg[12]_i_2_n_0\,
      CO(2) => \sample_n_reg[12]_i_2_n_1\,
      CO(1) => \sample_n_reg[12]_i_2_n_2\,
      CO(0) => \sample_n_reg[12]_i_2_n_3\,
      CYINIT => '0',
...
\sample_n_reg[15]_i_5\: unisim.vcomponents.CARRY4
     port map (
      CI => \sample_n_reg[12]_i_2_n_0\,
      CO(3 downto 2) => \NLW_sample_n_reg[15]_i_5_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \sample_n_reg[15]_i_5_n_2\,
      CO(0) => \sample_n_reg[15]_i_5_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_sample_n_reg[15]_i_5_O_UNCONNECTED\(3),
...
\sample_n_reg[4]_i_3\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \sample_n_reg[4]_i_3_n_0\,
      CO(2) => \sample_n_reg[4]_i_3_n_1\,
      CO(1) => \sample_n_reg[4]_i_3_n_2\,
      CO(0) => \sample_n_reg[4]_i_3_n_3\,
...
\sample_n_reg[8]_i_3\: unisim.vcomponents.CARRY4
     port map (
      CI => \sample_n_reg[4]_i_3_n_0\,
      CO(3) => \sample_n_reg[8]_i_3_n_0\,
      CO(2) => \sample_n_reg[8]_i_3_n_1\,
      CO(1) => \sample_n_reg[8]_i_3_n_2\,
      CO(0) => \sample_n_reg[8]_i_3_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
...
sample_valid_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
sample_valid_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (
...
entity bajie7020_firoutmixer_0_0 is
  ...
  attribute X_CORE_INFO of bajie7020_firoutmixer_0_0 : entity is "firoutmixer,Vivado 2021.2";

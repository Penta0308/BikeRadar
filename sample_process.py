...
sheetnames = ["iladata0.csv", "iladata3.csv"]
...
for sheetname in sheetnames:
    df = pd.read_csv('iladata/'+sheetname, header=0, skiprows=[1,], index_col=0, dtype={"bajie7020_i/rfb_fir/rfb_fir_out/system_ila_1/inst/net_slot_0_axis_tdata[63:0]": "str"})
    chs = df["bajie7020_i/rfb_fir/rfb_fir_out/system_ila_1/inst/net_slot_0_axis_tdata[63:0]"]
    #print(chs)
    cha = chs.apply(d2a)
    chb = chs.apply(d2b)
    df["cha"] = cha
